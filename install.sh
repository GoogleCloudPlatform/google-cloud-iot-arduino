...
export MAIN_PLATFORMS='declare -A main_platforms=( [esp8266]="esp8266:esp8266:huzzah:eesz=4M3M,xtal=80" [esp32]="esp32:esp32:featheresp32:FlashFreq=80" [MKR1000]="arduino:samd:mkr1000")'

# associative array for other platforms that can be called explicitly in .travis.yml configs
# this will be eval'd in the functions below because arrays can't be exported
export SAMD_PLATFORMS='declare -A samd_platforms=( [MKR1000]="arduino:samd:mkr1000")'
